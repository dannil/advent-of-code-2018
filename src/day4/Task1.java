...
public class Task1 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Guard guard = getGuardWithMostMinutesAsleep(guards);
    ...
    private static Guard getGuardWithMostMinutesAsleep(Collection<Guard> guards) {
        Guard guardWithMostMinutesAsleep = new Guard(-1);
        int mostMinutesAsleep = 0;
        for (Guard guard : guards) {
            int guardMinutesAsleep = guard.getTotalMinutesAsleep();
            if (guardMinutesAsleep > mostMinutesAsleep) {
                mostMinutesAsleep = guardMinutesAsleep;
